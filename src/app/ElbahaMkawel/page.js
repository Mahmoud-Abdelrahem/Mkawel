...
const slides = [
  {
    id: 1,
    title: "مقاول اسفلت الباحة يبحث عنه العديد من العملاء للقيام بعملهم بشكل مثالي",
    text: "حيث يوفر أفضل مقاول طرق الباحة أو أي منطقة أخرى في المملكة وخارجها، العمل بدقة كبيرة وتوفير حلول لجميع مشاكل الرصف والأسفلت والطرقات المتعرجة",
    img: "/photo25.jpg",
  },
  {
    id: 2,
    title: "تحتاج أعمال اسفلت الباحة وباقي المناطق السعودية، لشخص على دراية كاملة بكل ما تحتاج إليه عملية رصف الطرق",
    text: "بالإضافة لعمل طُرق من الصفر لم يكن موجود بها أسفلت من قبل إلخ.. وبدون المزيد من المقدمات، نتعرف في المقال على دور أفضل مقاول اسفلت الباحة وكيفية العثور عليه",
    img: "/photo24.jpg",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    title: "اسعارنا تنافس أي أسعار خارجية في المنطقة الباحة",
      ...
      <section className="bg-gray-100 py-16 px-6 md:px-12 lg:px-24" dir="rtl">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8 hover:text-gray-900 transition duration-300">
            مقاول اسفلت الباحة يبحث عنه العديد من العملاء للقيام بعملهم بشكل مثالي وفي أفضل شكل وصورة ممكنة، وسواء كان البحث عبر مواقع التواصل الاجتماعي المختلفة أو محرك جوجل، فهو يكون بعنوان الأفضل دائماً والذي يعمل في أهم شركات سفلتة الطرق في السعودية، حيث يوفر أفضل مقاول طرق الباحة أو أي منطقة أخرى في المملكة وخارجها، العمل بدقة كبيرة وتوفير حلول لجميع مشاكل الرصف والأسفلت والطرقات المتعرجة، بالإضافة لعمل طُرق من الصفر لم يكن موجود بها أسفلت من قبل إلخ.. وبدون المزيد من المقدمات، نتعرف في المقال على دور أفضل مقاول اسفلت الباحة وكيفية العثور عليه ومعلومات عن شركتنا بشكل عام، تابع.
          </p>
        </div>
        <hr className="border-gray-300 my-6" />
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-800 mb-6 transition duration-300 hover:text-blue-600">
            شركة سفلتة الطرق الباحة
          </h2>
          <p className="text-xl text-gray-700 leading-relaxed mb-8 hover:text-gray-900 transition duration-300">
            يقع مقر شركتنا المتواضعة شركة سفلتة الطرق الباحة في هذه المنطقة بالمملكة العربية السعودية، والتي تحتوي على أفضل مقاول اسفلت الباحة والعاملين في باقي المناطق داخل المملكة وخارجها، وتقدم الشركة خدماتها مقابل أسعار رمزية، فهي تتيح ارخص متر اسفلت في السعودية مقارنة بخدمات الشركات الأخرى، مع إتاحة عروض مميزة من وقت لآخر للأفراد والشركات لتنفيذ الخدمات بكفاءة عالية وبسعر مناسب، وتستخدم شركتنا أفضل مواد الأسفلت في صناعة طبقات رصف الطرق، بالإضافة لاستخدامها آلات وأدوات هي الأفضل في تنفيذ هذه المهمة خلال وقت قصير وسريع، كل هذا يتم معاينته من قبل أفضل مقاول اسفلت في الباحة والعاملين في شركتنا.
          </p>
        </div>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-800 mb-6 transition duration-300 hover:text-blue-600">
            مقاول أعمال اسفلت الباحة
          </h2>
          <p className="text-xl text-gray-700 leading-relaxed mb-8 hover:text-gray-900 transition duration-300">
            تحتاج أعمال اسفلت الباحة وباقي المناطق السعودية، لشخص على دراية كاملة بكل ما تحتاج إليه عملية رصف الطرق، سواء كانت أمام المجمعات السكنية والبيوت أو داخل الفيلات والقصور والمستودعات والمخازن ومحطات البنزين وغيرهم، حيث تحتاج هذه العملية لمعاينة أولية وتخطيط جيد من البداية حتى إتمامها بنجاح، خاصة في حالة وجود اسفلت قديم يحتوي على عدد من الحفر والتعرجات ومشاكل أخرى، ويكون من الصعب أن توازي بين القديم والجديد، حيث لا تصلح عملية الترقيع في هذه الحالة، لن يجب أن يتم وضع المادة الأسفلتية بدقة كبيرة في المكان المناسب وبالشكل الصحيح لكي يحدث تماسك بشكل جيد، وهذا هو دور أفضل مقاول اسفلت الباحة في أفضل شركات سفلتة الطرق في السعودية وخارجها.
          </p>
        </div>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-800 mb-6 transition duration-300 hover:text-blue-600">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8 hover:text-gray-900 transition duration-300">
            لمن يريد استئجار أفضل مقاول اعمال اسفلت في الباحة والمملكة العربية السعودية بشكل عام، سواء يومياً أو لفترة من الزمن للقيام بعدة أعمال، يمكنه التواصل مع شركة سفلتة الطرق الخاصة بنا، وذلك عبر عدد من الأرقام التي تتلقى كل المكالمات والاستفسارات الخاصة بالعملاء، حتى في أيام العطلات يمكنكم التواصل معنا، كما يمكن التواصل عبر الصفحات والحسابات الخاصة بنا على الإنترنت وسوف يتم الرد عليكم بشكل فوري لتنفيذ الخدمة في أسرع وقت، ويمكنكم متابعة المزيد من المعلومات فيما يلي:
          </p>
          <ul className="list-disc pr-6 space-y-2 text-gray-700">
            <li className="hover:text-gray-900 transition duration-300">يعمل مقاول اسفلت الباحة الخاص بنا على صيانة وإصلاح أي أضرار وشقوق في الطرق بتكلفة قليلة وفي وقت سريع وبجودة عالية.</li>
